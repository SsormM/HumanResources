...
<form action="/roleInfo_update" class="form-horizontal">
    ...
    <div class="row">
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" name="roleId" readonly value="${requestScope.role.roleId}"
    ...
    <div class="row">
        <div class="col-sm-10">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <textarea class="form-control" name="roleDesc">${requestScope.role.roleDesc}</textarea>
                </div>
            </div>
