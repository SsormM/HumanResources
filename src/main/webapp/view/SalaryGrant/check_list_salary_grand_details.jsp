    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("input[name=uncomplete]").click(function () {
                $("#salaryGrantForm").attr('action', '/uncompleteSalaryGrant');
                $("#salaryGrantForm").submit();
            })

            $("input[name=complete]").click(function () {
                $("#salaryGrantForm").attr('action', '/completeSalaryGrant');
                $("#salaryGrantForm").submit();
            })
        ...
        <table class="table table-condensed table-striped">
            ...
            <c:forEach items="${requestScope.humanFiles}" var="humanFile" varStatus="status">
                <tr>
                    ...
                    <th><input class="1" type="text" name="salaryGrantDetails[${status.index}].bounsSum"
                               value="${humanFile.salaryGrantDetail.bounsSum}"></th>
                    <th><input class="2" type="text" name="salaryGrantDetails[${status.index}].saleSum"
                               value="${humanFile.salaryGrantDetail.saleSum}"></th>
                    <th><input class="3" type="text" name="salaryGrantDetails[${status.index}].deductSum"
                               value="${humanFile.salaryGrantDetail.deductSum}"></th>
