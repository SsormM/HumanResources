        ...
        $.getJSON("/search", $('#searchForm').serialize() + "&page=1&rows=10", function (result) {
            ...
            for (var i = 0; i < result.rows.length; i++) {
                ...
                trs = "<tr>" +
                    ...
                    "<td><a href='/recovery_human_resource?hufId=" + result.rows[i].hufId + "&target=update_human_resource' " +
                    "onclick = 'if(dele()==false)return false;'>恢复</a></td>" +
                    "</td>" +
                    "</tr>";
                tbody += trs;
            }
