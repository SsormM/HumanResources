...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $.getJSON("/showConfigPublicCharByKind", "attributeKind=薪资标准",
                function (result) {
                    for (var i = 0; i < result.length; i++) {
                        if (result[i].attributeName != $("#salary_standard_id").val()) {
...
<div class="container-fluid">
    ...
    <div class="row-fluid">
        <div class="table-responsive">
            <form action="/update_human_resource" method="post" role="form" id="humanFileForm">
                ...
                <table class="table table-bordered" STYLE="background-color:rgba(114,202,204,0.8)">
                    ...
                    <tr>
                        ...
                        <td><input name="humanMajorKindName" id="human_major_kind_id" readonly
                            ...
                            <input name="humanMajorKindId" value="${requestScope.humanFile.humanMajorKindId}" type="hidden">
                        </td>
