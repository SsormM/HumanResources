    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("input[name=uncomplete]").click(function () {
                $("#salaryStandardForm").attr('action','');
                $("#salaryStandardForm").submit();
            })

            $("input[name=update]").click(function () {
                $("#salaryStandardForm").attr('action','/updateSalaryStandard ');
                $("#salaryStandardForm").submit();
            })
        ...
        <div class="table-responsive">
            <form action="" method="post" role="form" id="salaryStandardForm">
                ...
                <table class="table table-bordered" STYLE="background-color:rgba(114,202,204,0.8)">
                    <caption><h1 style="display: block;float:left;width: 50%">薪酬标准修改</h1>
                        <input type="button" style="float:right;width:200px;height:50px;margin: 20px;font-size: 20px"
                               name="uncomplete"
                               class="btn btn-danger" value="取消"/>
                        <input type="button" style="float:right;width:200px;height:50px;margin: 20px;font-size: 20px"
                               name="update"
                    ...
                    <tr>
                        <th><span>修改意见</span></th>
                        <td colspan="7"><textarea name="checkComment" id="check_comment" style="resize:none;font-size: 20px;"
