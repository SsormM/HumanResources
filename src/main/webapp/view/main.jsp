        ...
        <div class="navbar-header pull-right" role="navigation">
            <ul class="nav ace-nav">
                ...
                <li class="light-blue"><a data-toggle="dropdown" href=""
                        ...
                        class="user-info"> <small>欢迎光临<br/>${sessionScope.user.uName}</small>
                    ...
                    <ul
                        ...
                        <li><a href="/out"> <i class="icon-off"></i> 退出
                        </a></li>
                    </ul>
                </li>
            </ul>
            ...
            <ul class="nav nav-list">
                ...
                <li><a href="javascript:void(0)" target="mainframe"
                    ...
                    <ul class="submenu">
                        ...
                        <li><a href="/staffinfo_list?target=staffinfo/staffInfo_list" target="mainframe"> <i
                                class="icon-double-angle-right"></i> 员工管理
                        </a></li>
                        <li><a href="/roleInfo_list?target=roleinfo/roleInfo_list" target="mainframe"> <i
                                class="icon-double-angle-right"></i> 角色管理
                        </a></li>
                        <li><a href="/staffinfo_list?target=roleinfo/staffInfo_role_list" target="mainframe"> <i
                        ...
                        <li><a href="/roleInfo_list?target=anthotychange/anthorty_changeList" target="mainframe"> <i
                                class="icon-double-angle-right"></i> 权限变更</a></li>
                        <li><a href="/dataDictionary_list?target=dataDictionary_list" target="mainframe"> <i
                                class="icon-double-angle-right"></i> 数据字典</a></li>
                    </ul>
                </li>
                <li><a href="javascript:void(0)" target="mainframe"
                       class="dropdown-toggle"> <i class="icon-desktop"></i> <span
                        class="menu-text"> 人力资源档案管理 </span> <b class="arrow icon-angle-down"></b>
                </a>

                    <ul class="submenu">

                        <li><a href="view/HumanResource/add_human_resource.jsp" target="mainframe"> <i
                                class="icon-double-angle-right"></i> 人力资源档案登记
                        </a></li>
                        <li><a href="view/HumanResource/list_human_resource.jsp" target="mainframe"> <i
                                class="icon-double-angle-right"></i> 人力资源档案复核
                        </a></li>
                        <li><a href="view/HumanResource/select_human_resource.jsp" target="mainframe"> <i
                                class="icon-double-angle-right"></i> 人力资源档案查询
                        </a></li>
                        <li><a href="view/HumanResource/deleted_human_resource.jsp" target="mainframe"> <i
                                class="icon-double-angle-right"></i> 人力资源档案恢复
                        </a></li>
                    </ul>
                </li>
                <li><a href="javascript:void(0)" target="mainframe"
                       class="dropdown-toggle"> <i class="icon-desktop"></i> <span
                        class="menu-text"> 薪资标准管理 </span> <b class="arrow icon-angle-down"></b>
                </a>

                    <ul class="submenu">

                        <li><a href="view\SalaryStandard\add_salary_standard.jsp" target="mainframe"> <i
                                class="icon-double-angle-right"></i> 薪酬标准登记
                        </a></li>
                        <li><a href="view\SalaryStandard\list_salary_standard.jsp" target="mainframe"> <i
                                class="icon-double-angle-right"></i> 薪酬标准登记复核
                        </a></li>
                        ...
                        <li><a href="view/SalaryGrant/check_list_salary_grand.jsp" target="mainframe"> <i
                                class="icon-double-angle-right"></i> 薪酬发放登记复核
                        </a></li>
                        <li><a href="view/SalaryGrant/select_salary_grand.jsp" target="mainframe"> <i
                                class="icon-double-angle-right"></i> 薪酬发放查询
                        </a></li>
                    </ul>
                </li>
                ...
                <li><a href="javascript:void(0)" target="mainframe"
                       class="dropdown-toggle"> <i class="icon-desktop"></i> <span
                        class="menu-text"> 调动管理 </span> <b class="arrow icon-angle-down"></b>
                </a>

                    <ul class="submenu">

                        <li><a href="view/MajorChange/search_human_resource.jsp" target="mainframe"> <i
                                class="icon-double-angle-right"></i> 调动登记
                        </a></li>
                        <li><a href="view/MajorChange/check_list_major_change.jsp" target="mainframe"> <i
                                class="icon-double-angle-right"></i> 调动审核
                        </a></li>
                ...
                <li><a href="javascript:void(0)" target="mainframe"
                       class="dropdown-toggle"> <i class="icon-desktop"></i> <span
                        class="menu-text"> 职位发布 </span> <b class="arrow icon-angle-down"></b>
                </a>
